    ...
    return (
        <section
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch  reveal-up">
                ...
                <form action="https://getform.io/f/bkkppgvb" method='POST' className='xl:pl-10 2xl:pl-20'>
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            autoComplete='email'
                            required
                            placeholder='jainish@example.com' 
                            className="text-field" />
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <textarea name="message" id="message" className='text-field resize-y min-h-32 max-h-80' placeholder='Hi! '>
